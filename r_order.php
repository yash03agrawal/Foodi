...
<!--                    <li class="nav-item"><a class="nav-link" href="#Contact">Contact</a></li>-->
        ...
        <div class="container text-center">
            ...
            <table class="table">
              <thead>
                  ...
                  <tr class="thead-dark">
                      ...
                      <th scope="col">View Details and Edit Status</th>
                </tr>
              </thead>
            ...
            <tbody>
                  <?php
                    ...
                    $sql = "SELECT * FROM c_order where r_id=$r_id order by DATE(o_date_time) DESC";
                    if (!$conn->query($sql))
                    {
                        die('Error: ' . $conn->error);
                    }
                    ...
                    while ($row = $result->fetch_array(MYSQLI_ASSOC)) {
                        ...
                        $sql1 = "SELECT f_name,l_name,contact from customer where u_name='$field2name' ";
                        if (!$conn->query($sql1))
                        {
                            die('Error: ' . $conn->error);
                        }
        ...
        <script type="text/javascript">
            ...
            function handler(num){
                //console.log(num);
                window.location.href = "r_order_details.php?id=" + num;
