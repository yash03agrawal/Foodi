		...
		<div class="container mt-5">
            <div class="row justify-content-center">
                <div class="col-md-6">
                    ...
                    <form method="get" action="order_in_a_restaurant_result.php">
                        <div class="form-row">
						...
						<div class="form-row">
							<div class="col form-group">
								<select id="restaurant" class="form-control" name="restaurant" required>
									  <option value="1">Andhra Vantillu</option>
									  <option value="2">Beijing Eats</option>
									  <option value="3">Don's Pizza</option>
									  <option value="4">Everest</option>
									  <option value="5">Good Bowl</option>
									  <option value="6">Kai Foods</option>
								</select>
							</div>
						</div>	
